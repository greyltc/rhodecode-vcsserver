...

{
  ...
  hg-evolve = super.buildPythonPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "49dc14fe7322b3ded107a96e47c1f0a75a19472d4b6b7ce80b670ab25c742aaf";
    };
    meta = {
  ...
  hgsubversion = super.buildPythonPackage {
    ...
    src = fetchurl {
      ...
      sha256 = "9fed1e68411130b0447d0bbd217183830f5f1eaaaa0d5aa7de24609895058998";
    };
    meta = {
  ...
  mercurial = super.buildPythonPackage {
    name = "mercurial-4.6.1";
    buildInputs = with self; [];
    doCheck = false;
    propagatedBuildInputs = with self; [];
    src = fetchurl {
      url = "https://files.pythonhosted.org/packages/12/e7/46894628ed3d6b0ae1e324523b09fdb8a90f0720bebe43cab88e0ea91b39/mercurial-4.6.1.tar.gz";
